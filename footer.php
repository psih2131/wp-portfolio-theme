<!-- Footer Start -->
    <footer id="mxd-footer" class="mxd-footer">
      ...
      <div class="mxd-footer__text-wrap">
        ...
        <div class="mxd-footer__fullwidth-text personal anim-top-to-bottom">
          <svg class="mxd-footer__svg-v2" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="footer-blocks__column animate-card-3">
          ...
          <div class="footer-blocks__card fullheight-card">
            ...
            <div class="footer-blocks__nav">
              ...
              //ВЫВОД МЕНЮ
              'menu'            => 'footer-meny',              // (string) Название выводимого меню (указывается в админке при создании меню, приоритетнее 
              ...
              'walker'          => new Kuzmych_Walker_Nav_Menu_Footer(),
              'theme_location'  => 'footermeny'               // (string) Расположение меню в шаблоне. (указывается ключ которым было зарегистрировано меню в функции register_nav_menus)
              ) ); ?>
            ...
            <div class="footer-blocks__links anim-uni-in-up">
              ...
              <?php
              //ПОВТОРИТЕЛЬ ACF
              if( have_rows('footer_menyu_dokumkentov','options') ):
              while ( have_rows('footer_menyu_dokumkentov','options') ) : the_row();
              ?>

              <a class="btn btn-line-xsmall btn-muted slide-right anim-no-delay" href="<?php the_sub_field('ssylka'); ?>">
                <span class="btn-caption"><?php the_sub_field('nazvanie'); ?></span>
        ...
        <div class="footer-blocks__column animate-card-3">
          ...
          <div class="footer-blocks__card">
            <p class="mxd-point-subtitle anim-uni-in-up">
              ...
              <a href="<?php the_field('footer_telegram', 'option'); ?>"><?php the_field('footer_telegram', 'option'); ?></a>
            </p>
          </div>
          <!-- inner card -->
        ...
        <div class="footer-blocks__column animate-card-3">
          ...
          <div class="footer-blocks__card fullheight-card">
            ...
            <div class="footer-blocks__block">
              <!-- card title -->
              <div class="footer-blocks__title anim-uni-in-up">
                <p class="footer-blocks__title-l">Соц-сети</p>
              </div>
              <!-- footer socials -->
              <div class="footer-blocks__socials">
                <ul class="footer-socials">
                  <?php
                  if( have_rows('footer_socz_seti','options') ):
                  while ( have_rows('footer_socz_seti','options') ) : the_row();
                  ?>

                  <li class="footer-socials__item anim-uni-in-up"><a href="<?php the_sub_field('ssylka'); ?>" class="footer-socials__link" target="_blank"><?php the_sub_field('tekst'); ?></a></li>
            ...
            <div class="footer-blocks__links anim-uni-in-up">
              <p class="t-xsmall t-muted">
                <a class="no-effect" target="_blank">Kuzmych Studio</a>
    ...
    <script>
      const statsCounter1 = new countUp.CountUp("stats-counter-1", 40, optionsPlus);
      const statsCounter2 = new countUp.CountUp("stats-counter-2", 80, optionsPercent);
      const statsCounter3 = new countUp.CountUp("stats-counter-3", 3, optionsPlus);
      const statsCounter4 = new countUp.CountUp("stats-counter-4", 50, optionsPlus);
      statsCounter1.start();
      statsCounter2.start();
      statsCounter3.start();
      statsCounter4.start();
