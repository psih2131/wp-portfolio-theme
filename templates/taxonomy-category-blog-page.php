            ...
            <div class="col-12 col-xl-4 mxd-grid-item no-margin">
              <div class="inner-headline__breadcrumbs loading__fade">
                <div class="breadcrumbs__nav">
                  ...
                  <?php
                  $mxd_blog_archive = get_post_type_archive_link( 'blog' );
                  if ( $mxd_blog_archive ) :
                    ?>
                  <span>
                    <a href="<?php echo esc_url( $mxd_blog_archive ); ?>">Блог</a>
                  </span>
                  <?php endif; ?>
                  <span class="current-item"><?php echo esc_html( single_term_title( '', false ) ); ?></span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="mxd-container grid-container">
      <div class="mxd-posts-area loading__fade">
        ...
        <div class="mxd-posts-container mxd-grid-item">
          ...
          $mxd_term_id = (int) get_queried_object_id();
          $args        = array(
            'orderby'        => 'date',
            'order'          => 'DESC',
            'posts_per_page' => -1,
