...
<html lang="en" dir="ltr">
  ...
  <head>
    ...
    <link rel="icon" href="<?php bloginfo('template_directory') ?>/img/favicon/favicon.ico" sizes="any">
    <link rel="icon" href="<?php bloginfo('template_directory') ?>/img/favicon/icon.svg" type="image/svg+xml">
    <link rel="apple-touch-icon" href="<?php bloginfo('template_directory') ?>/img/favicon/apple-touch-icon.png">
    <link rel="manifest" href="<?php bloginfo('template_directory') ?>/img/favicon/manifest.webmanifest">
    ...
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory') ?>/css/loaders/loader.css">
